...
<div class="col-lg-12">
  <div class="card">
  <div class="card-body">
              <h5 class="card-title">Reporte de ingresos fallidos</h5>
              <p class="card-text">

          <?php	
          include_once  'conexion.php';
          $tipo_evento = "Ingreso al portal de usuario fallido";
          ...
          echo "Cantidad de ingresos fallidos: " . $cantidadIngresosFallidos;
          ?>
...
?>     
            ...
            <div class="card-body">
              <h5 class="card-title">Ultimos 10 ingresos fallidos</h5>
