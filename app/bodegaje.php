...
$sql = "SELECT * FROM bodegaje ORDER BY id DESC";
  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Bodegaje de mercancia</h5>
            <table class="table table-striped" id="tabla_bodegaje">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo $dato['cliente_nombres']; ?></td>
                  <td><?php echo $dato['bodega']; ?></td>
                  <td><?php echo $dato['mercaderia_almacenada']; ?></td>
                  <td><?php echo $dato['espacio_ocupado']; ?></td>
